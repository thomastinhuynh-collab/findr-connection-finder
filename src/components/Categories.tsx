...
const Categories = () => {
  ...
  return (
    <section className="py-24 relative grain-texture" style={{ backgroundColor: 'hsl(38 33% 93%)' }}>
          ...
          {categories.map((cat, index) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(to top, hsl(0 0% 5% / 0.85) 0%, hsl(0 0% 5% / 0.3) 50%, hsl(0 0% 5% / 0.1) 100%)',
                }}
              />
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(to top, hsl(18 66% 47% / 0.3) 0%, transparent 50%)',
                }}
              />

              <div className="absolute inset-0 flex flex-col justify-end p-6">
                <h3 className="text-xl font-serif font-bold mb-1" style={{ color: 'hsl(38 33% 93%)' }}>
                  {cat.name}
                </h3>
                <p className="text-sm opacity-80 group-hover:opacity-100 transition-opacity" style={{ color: 'hsl(38 33% 93%)' }}>
                  {cat.description}
                </p>
                <div
